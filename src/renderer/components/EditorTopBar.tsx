  ...
  return (
    <div className="h-16 border-b border-[#262631] flex items-center px-6 gap-3 bg-[#151519]">
      <div className="min-w-0 flex-1">
        <p className="text-[10px] text-gray-500 uppercase tracking-[0.18em] font-bold mb-0.5">
          Canção atual
        </p>
        <input
          type="text"
      ...
      <div className={`hidden xl:flex items-center gap-1.5 text-[10px] uppercase tracking-wider font-bold rounded-full px-2.5 py-1 border ${
        saving
